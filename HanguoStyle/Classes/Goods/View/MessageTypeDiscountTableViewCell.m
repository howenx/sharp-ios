//
//  MessageTypeDiscountTableViewCell.m
//  HanguoStyle
//
...
#define sapce 10
#define H 470
@implementation MessageTypeDiscountTableViewCell
...
-(void)initSubViews
{
    ...
    self.iconImageView = [[UIImageView alloc]initWithFrame:CGRectMake(15, 15, GGUISCREENWIDTH - 50, 592/2)];
    self.iconImageView.contentMode =  UIViewContentModeScaleAspectFill;
    self.iconImageView.clipsToBounds = YES;
    [self.bgView_ addSubview:self.iconImageView];
    
    
    self.titleLabel_ = [[UILabel alloc]initWithFrame:CGRectMake(15, PosYFromView(self.iconImageView, 25/2),GGUISCREENWIDTH - 50 , 15)];
